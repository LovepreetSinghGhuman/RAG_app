...
# Here we are implementing the "Agentic" chunking strategy, which splits documents into smaller pieces based on agent-driven criteria.
...
doc = documents[0]  #We want to chunk the first document for demonstration
